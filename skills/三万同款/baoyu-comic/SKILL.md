...
**Image generation engine**: Uses bundled `scripts/generate_image.py` (Seedream 5.0 Lite via Easyclaw API). No external API key required — reads credentials from `~/.easyclaw/` automatically.
