...
// 步骤 6: AI 生成配图
console.log('🖼️  步骤 6: AI 生成配图\n');
console.log('调用命令示例:');
console.log(`python ../scripts/generate_image.py --prompt "精美的${TOPIC}场景，日式风格，自然光线，9:16竖图" --filename "${TOPIC.replace(/\s/g, '_')}_01.jpg" --aspect-ratio 9:16 --resolution 2K`);
console.log('\n（实际生图需要 Python 环境和 EasyClaw 配置）');
...
console.log('   • *.jpg - AI 生成配图（如启用）');
console.log('\n📋 下一步:');
console.log('   1. 根据 AI 味检测结果优化文案');
console.log('   2. 使用 AI 生成配图（或自行准备）');
console.log('   3. 手动复制到小红书 App 发布\n');
