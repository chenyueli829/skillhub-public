...
#### 1. 技术规范
- [SKILL.md](02-项目/002-产品工作台/Star-Office-UI/SKILL.md) - AI Agent使用的完整技术文档
  - URL解析逻辑
  - 工作流程详解
  - MCP工具调用规范
  - 路径计算算法
...
### 深度定制
1. **[SKILL.md](02-项目/002-产品工作台/Star-Office-UI/SKILL.md)** - 理解技术细节
...
#### ...理解技术实现细节
→ [SKILL.md](02-项目/002-产品工作台/Star-Office-UI/SKILL.md)
...
- Skill主文档: [SKILL.md](02-项目/002-产品工作台/Star-Office-UI/SKILL.md)
